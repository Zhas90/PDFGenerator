                        ...
                        <fo:table>
                            <fo:table-body>
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:block padding-top="25pt"><xsl:value-of select="accountFrom"/></fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block color="#C1C5C4">ПЕРЕВОД НА СЧЕТ:</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block><xsl:value-of select="accountTo"/></fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block padding-top="25pt" color="#C1C5C4">ДАТА ПЕРЕВОДА:</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block padding-top="25pt"><xsl:value-of select="transferDate"/></fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                        </fo:table>                      
